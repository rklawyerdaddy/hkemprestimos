...
import { LayoutDashboard, Users, Banknote, ArrowRightLeft, LogOut } from 'lucide-react';
...
const Layout = ({ children }) => {
    ...
    return (
        <div className="flex h-screen bg-slate-50 overflow-hidden">
            ...
            <aside className="w-72 bg-gradient-to-b from-slate-900 via-blue-900 to-slate-900 text-white flex flex-col shadow-2xl relative z-20">
                <div className="p-8">
